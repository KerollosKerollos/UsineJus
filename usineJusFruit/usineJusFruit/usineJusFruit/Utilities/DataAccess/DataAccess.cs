...
namespace usineJusFruit.Utilities.DataAccess
{
    public abstract class DataAccess : IDataAccess
    {
        ...
        public abstract ProductsCollection GetAllProducts();
        public abstract ReservationsCollection GetAllReservations();
        public abstract FacturesCollection GetAllFactures();
        public abstract TicketsCollection GetAllTickets();

        //public abstract ClientsCollection GetAllClients();
