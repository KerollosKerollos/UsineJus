...
namespace Brasse.Model.Restaurant.People
{
    public abstract class Person
    {
        ...
        //Constructeur pour créer un object de la classe person
        public Person(int id, string lastName = "nom", string firstName = "prenom", bool gender = true,
        ...
        /// <summary>
        /// Totalisteur d'instance de classe person
        /// </summary>
